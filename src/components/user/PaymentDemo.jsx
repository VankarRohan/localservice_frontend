                                        ...
                                        <ul className="list-group bg-gradient-default" style={{ border: "1px solid black" }} >
                                            <li className="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                                ...
                                                <div className="ms-auto text-end">
                                                    ...
                                                    >
                                                        <i className="material-icons text-sm me-3">delete</i>Delete
                                                    </button><br />

                                                    <Link to={`/user/paymentdemo/updateaddress/${address._id}`}
                                                        className="btn btn-link bg-gradient-info text-info text-gradient px-3  mb-auto"
                                                        style={{ width: "110px", marginTop: "9px" }}
                                                        value={address._id}
                                                    >

                                                        <i className="material-icons text-sm me-3">edit</i>Update
                                                    </Link>
                                                    <br />
                                                    <button
                                                    ...
                                                    >
                                                        <i className="material-icons text-sm me-3" type="checkbox">add</i>Select
                                                    </button>
                                                </div>
                                            </li>
